...
//        drawBoard(board);
    ...
    private static void makeMove(GameModel game, String Color) throws ResponseException, IOException {
        ...
        Scanner scanner = new Scanner(System.in);
        String line = scanner.nextLine();
        int col = line.charAt(0) - 48;
        int row = line.charAt(1) - 'a' + 1;
        ChessPosition startPosition = new positionImple(col, row);
        System.out.printf("Where do you want to move: ex(1a)%n>>>");
        Scanner scanner2 = new Scanner(System.in);
        String line2 = scanner2.nextLine();
        int col2 = line2.charAt(0) - 48;
        int row2 = line2.charAt(1) - 'a' + 1;
        ChessPosition endPosition = new positionImple(col2, row2);
